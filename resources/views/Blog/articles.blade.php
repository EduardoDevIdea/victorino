            ...
            <div class="rd-navbar-main-outer">
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel"> 
                  ...
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand"><a href="{{ url('/#home') }}">
                    <a href="{{ url('/#home') }}">
                    @if($logo_inicio == null)
                      <div class="rd-navbar-brand"><a href="{{ url('/#home') }}"><img class="brand-logo-light" src="images/default_images/logo/LogoAzul.PNG" alt="" width="140" height="57" srcset="images/logo-default-280x113.png 2x"/></a></div>
                    @else 
                      <div class="rd-navbar-brand"><a href="{{ url('/#home') }}"><img class="brand-logo-light" src="{{asset('storage/'.$logo_inicio->path)}}" alt="" width="140" height="57" srcset="images/logo-default-280x113.png 2x"/></a></div>
                    @endif
                      <!-- <img class="brand-logo-light" src="{{asset('images/$logo_inicio')}}" alt="" width="140" height="57" srcset="images/logo-default-280x113.png 2x"/></a> -->
                    </a>
                  </div>
                </div>
          ...
          <div class="wow fadeIn">
            <div class="row row-60">
              ...
              @if($logo_inicio == null)
                  ...
                  @endif
                <!-- <img src="images/logo-default1-140x57.png" alt="" width="140" height="57" srcset="images/logo-default-280x113.png 2x"/> -->
              </a></div>
              <div class="col-12">
                <ul class="footer-minimal-nav">
